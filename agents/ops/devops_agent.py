...
class DevOpsAgent:
    ...
    def rollback_service(self, service_name: str, target_version: str) -> DeploymentStatus:
        """
        ...
        """
        self.logger.info(f"Rolling back service {service_name} to version {target_version}")
