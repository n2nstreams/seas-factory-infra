...
// Default health check configurations - NEW STACK ONLY
const DEFAULT_HEALTH_CHECKS: HealthCheckConfig[] = [
  ...
  // Updated to use Next.js health endpoint during migration
  {
    name: 'backend-api',
    endpoint: 'internal', // Use internal check instead of calling self
    timeout: 5000,
    expectedStatus: 200,
    critical: true,
    retries: 3,
