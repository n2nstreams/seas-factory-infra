  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-stone-100 via-neutral-200 to-stone-200 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="relative">
              <div className="transition-opacity duration-1000">
                {currentView === 0 ? <AssemblyLineVisual /> : <DashboardVisual />}
                             ...
                             {/* View Indicator - Now Clickable */}
               <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-2">
                 <button 
                   onClick={() => setCurrentView(0)}
                   className={`w-3 h-3 rounded-full transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-green-800/50 ${currentView === 0 ? 'bg-green-800 shadow-lg' : 'bg-stone-400/60 hover:bg-stone-400/80'}`}
                   aria-label="Show assembly line view"
                 ></button>
                 <button 
                   onClick={() => setCurrentView(1)}
                   className={`w-3 h-3 rounded-full transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-green-800/50 ${currentView === 1 ? 'bg-green-800 shadow-lg' : 'bg-stone-400/60 hover:bg-stone-400/80'}`}
       ...
       <section className="py-20 bg-white/15 backdrop-blur-md border-y border-stone-400/30 w-full min-h-[60vh]">
         <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-16 2xl:px-24">
          <div className="space-y-12">
            {/* Metrics */}
            <div className="text-center space-y-8">
              <p className="text-stone-700 font-semibold text-lg">Trusted by founders who've already launched</p>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-16 max-w-6xl mx-auto">
            ...
            <div className="max-w-6xl mx-auto">
              <div className="bg-white/25 backdrop-blur-lg border border-stone-400/40 rounded-2xl p-8 lg:p-12 shadow-xl">
            ...
            <div className="text-center space-y-6">
              ...
              <div className="flex justify-center items-center space-x-6 lg:space-x-12 opacity-80">
                <div className="text-lg lg:text-xl font-bold text-stone-800">Google Cloud</div>
                <div className="text-lg lg:text-xl font-bold text-stone-800">Stripe</div>
                <div className="text-lg lg:text-xl font-bold text-stone-800">OpenAI</div>
                <div className="text-lg lg:text-xl font-bold text-stone-800">GitHub</div>
              </div>
            </div>
          </div>
        </div>
       ...
       <section id="features" className="py-20 relative w-full">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
       ...
       <section id="how-it-works" className="py-20 bg-gradient-to-br from-green-800/5 to-stone-200/60 backdrop-blur-sm w-full">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-6 mb-20">
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-stone-900">
          ...
          <div className="text-center mt-16">
            ...
            <p className="text-sm text-stone-600 mt-3">
             ...
             {/* Pricing Section */}
       <section id="pricing" className="py-20 bg-gradient-to-br from-stone-200/60 to-neutral-200/60 backdrop-blur-sm w-full">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 xl:gap-4">
            {pricingData.tiers.map((tier) => {
             ...
             {/* FAQ Section */}
       <section id="faq" className="py-20 relative w-full">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto">
            <Accordion type="single" collapsible className="space-y-4" defaultValue="item-1">
             ...
             {/* Final CTA Section */}
       <section className="py-20 bg-gradient-to-br from-green-800/10 to-stone-300/40 backdrop-blur-sm w-full">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12 max-w-3xl mx-auto">
             ...
             {/* Minimal Footer */}
       <footer className="bg-stone-900/95 backdrop-blur-lg text-white py-8 border-t border-stone-400/30 w-full">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
