...
class ProjectOrchestrator:
    ...
    def __init__(self):
        ...
        self.logger.info("ProjectOrchestrator initialized with agents: %s", list(self.agents.keys()))
    ...
    def process_request(self, request_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            payload = request_data.get("payload", request_data)  # Use request_data as payload if no explicit payload
            import time
            ...
            if not agent:
                ...
                error_msg = f"Unknown task type: {task_type}. Available: {available_tasks}"
