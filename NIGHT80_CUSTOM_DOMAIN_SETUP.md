...
- **API Domain**: `api.launch24.com` → Points to API Gateway and backend services
- **Frontend Domain**: `www.launch24.com` → Points to React frontend
- **Apex Domain**: `launch24.com` → Redirects to `www.launch24.com`
...
| Type | Name | Value | TTL |
|------|------|-------|-----|
| A | `api.launch24.com` | `<api_lb_ip_address>` | 300 |
| A | `www.launch24.com` | `<frontend_lb_ip_address>` | 300 |
| A | `launch24.com` | `<frontend_lb_ip_address>` | 300 |

### Example for Google Domains:
1. Go to [Google Domains](https://domains.google.com)
2. Select your domain (`launch24.com`)
...
```bash
# Test API domain
curl -I https://api.launch24.com/health

# Test frontend domain
curl -I https://www.launch24.com

# Test apex domain redirect
curl -I https://launch24.com
```
...
dig api.launch24.com
dig www.launch24.com

# Check from different locations
nslookup api.launch24.com 8.8.8.8
```

### SSL Certificate Issues
```bash
# Check certificate details
openssl s_client -connect api.launch24.com:443 -servername api.launch24.com
