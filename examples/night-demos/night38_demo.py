...
async def demonstrate_night38_workflow():
    ...
    if merge_result["success"]:
        ...
        print()
        print("📋 Summary:")
        print(f"   • Code generated by DevAgent")
        ...
        print(f"   • ReviewAgent added comprehensive feedback")
        print(f"   • PR merged automatically by Orchestrator")
    else:
...
async def demonstrate_workflow_with_failures():
    ...
    print(f"💬 Review comment added with issues and suggestions")
